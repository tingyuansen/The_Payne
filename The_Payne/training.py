...
class Payne_model(torch.nn.Module):
    def __init__(self, dim_in, num_neurons, num_features, mask_size):
        ...
        self.deconv1 = torch.nn.ConvTranspose1d(1, 30, mask_size, stride=3, padding=17)
        self.deconv2 = torch.nn.ConvTranspose1d(30, 30, mask_size, stride=3, padding=18)
        self.deconv3 = torch.nn.ConvTranspose1d(30, 1, mask_size, stride=3, padding=19, output_padding=1)
